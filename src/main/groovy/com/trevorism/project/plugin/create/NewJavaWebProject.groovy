...
class NewJavaWebProject implements NewProject {
    ...
    private String buildJavaWebBuildFile(){
        def builder = new BuildFileBuilder()
                ...
                .dependency(new Dependency("implementation", "org.glassfish.jersey.containers:jersey-container-servlet:2.32"))
                .dependency(new Dependency("implementation", "org.glassfish.jersey.media:jersey-media-json-jackson:2.32"))
                .dependency(new Dependency("implementation", "com.fasterxml.jackson.jaxrs:jackson-jaxrs-json-provider:2.11.3"))
